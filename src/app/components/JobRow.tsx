...
export default function JobRow({jobDoc}:{jobDoc:Job}) {
  return (
    <>
      <div className="bg-white p-4 rounded-lg shadow-sm relative transition-transform duration-300 ease-in-out hover:scale-105">
        ...
        <div className="flex grow gap-4">
          ...
          <div className="grow sm:flex">
            <div className="grow">
              <div>
                <Link href={`/show/${jobDoc.orgId}`} className="hover:underline text-gray-500 text-sm">{jobDoc.orgName || ''}</Link>
              </div>
...
className="text-blue-500 hover:underline"
 href={'/jobs/edit/'+jobDoc._id}>Edit</Link>
                    {' '}&middot;{' '}
                    <button
